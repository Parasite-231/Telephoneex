...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $existSql = "SELECT * FROM `myusers` WHERE username = '$username' and email = '$email'";
    ...
    if($numExistRows > 0){
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO `myusers` ( `username`,`email`, `password`, `date`) VALUES ('$username','$email', '$hash', current_timestamp())";
